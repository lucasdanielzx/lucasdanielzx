<div align="center">
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&color=2F81F7&center=true&vCenter=true&width=500&lines=Ol%C3%A1%2C+eu+sou+Lucas+Daniel;Desenvolvedor+FullStack;React+%7C+Rails+%7C+SQL+Server;Transformando+c%C3%B3digo+em+solu%C3%A7%C3%B5es." alt="Typing SVG" />
  </a>
</div>
...
Desenvolvedor de Software com foco em **sistemas corporativos e aplicações web**.

Atualmente, integro a equipe de desenvolvimento da **Sudoeste Informática**, atuando diretamente na sustentação e evolução de sistemas de gestão. Meu trabalho envolve desde a otimização de banco de dados até a implementação de regras de negócio complexas, garantindo que a tecnologia atenda às necessidades reais dos clientes.

* 🛠 **No dia a dia:** Manutenção de sistemas, criação de relatórios gerenciais e otimização de consultas em **SQL Server**.
* 🚀 **Foco atual:** Arquitetura de Software escalável e UX/UI Design.
* 🧠 **Objetivo:** Criar soluções escaláveis que unam a robustez do Backend com a fluidez do Frontend.
